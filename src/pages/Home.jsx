    ...
    <div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 inline-block">
        <p className="text-blue-700 font-semibold text-lg">
          {vehicles.length} <span className="font-normal text-sm">vehicles registered</span>
        </p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="text-left px-4 py-3 text-gray-600 font-semibold">Manufacturer</th>
